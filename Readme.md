...
This package contains distribution files required to style [KeyTable extension](https://datatables.net/extensions/keytable) for [DataTables](https://datatables.net/) .
